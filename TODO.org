...
Jezeli idzie o dopasowywanue patternow, to ono powinno
...
#+BEGIN_SRC scheme
  (define (matches pattern
	...
	((is identifier match/equal? '_)
	 bindings)
	((is bindings overridden-at? identifier)
	 (and (match/equal? (bindings identifier) subject)
	      bindings))
	(else
	 (set! (bindings identifier) subject)
	 bindings)))
