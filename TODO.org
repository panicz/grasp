	      ...
	      (and (= m n)
		   (match n
			...
			(highlight-comment-infix
		     ...
		     (n
		      ;; tutaj najpierw maczujemy pierwszy
		      ;; element jakp suffix, a nastepnie
		      ;; n-2 elementy dokladnie, a wreszcie
		      ;; ostatni element jako prefix
		      (match-comment-suffix ...)
		      ))))))))
