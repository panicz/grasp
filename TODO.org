...
tera piszemy 'extract!' od nowa

(define (extract! at: cursor from: document)
  ::(either pair HeadTailSeparator Comment)
  (let-values (((target parent cursor)
                (target+parent+cursor document cursor)))
    (otherwise #!null
