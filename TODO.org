...
to problem tutaj jest taki, ze watek wolajacy wyjdzie z zasiegu szybciej, niz
watek potomny.
...
A konkretnie - dlaczego w tym przypadku mamy dostep do starej wartosci?


No bo ogolnie chcielibysmy to miec mniej wiecej tak jak jest teraz, tylko
ze ta wartosc to powinna byc lokacja.
...
Ponadto, dobrze by bylo dorobic inwalidacje ekranu po stronie paintera,
zeby moc to wywolywac z poziomu ewaluacji.
