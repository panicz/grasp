...
Usuwamy =the-selection-range=. W tym celu musimy dodac parametr =(the-selection)=,
ktory powinien przyjmowac wartosc =DocumentEditor:selected-highlight=.

* 16.11.2024

Bysmy sie zajeli zmiana definicji =the-highlights=, ale 
trzeba jeszcze uwzglednic =DocumentEditor:selection-highlight:start/stop=
w ruchu kursora.

Najlepiej by bylo zmienic definicje =(move-cursor-left!)= i =(move-cursor-right!)=
tak zeby mialy postac:
