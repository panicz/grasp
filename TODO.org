...
(define (save-file-browser directory::string
  ...
  (let* ((window ::PopUp #!null)
         (text-field (TextField content: name-hint))
	 ...
	 (files (file-list directory
			     ...
			     ;; ustawiamy zawartosc text-field
			     ...)
			   (lambda (dir::java.io.File)::void
			     ;; zastepujemy to okno innym oknem
			     ...)))
...
(define-object (TextField)::Enchanted
  (define content::String "")
  ;; pytanie: czy uda sie uzyc kursora do tego,
  ;; zeby reprezentowac polozenie wewnatrz pola tekstowego?
  )
