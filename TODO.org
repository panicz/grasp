...
(define-interface Transform
  ...
  (unmap! point::Point)::void
  
  (map! point::Point result::Point)::void
  (unmap! point::Point result::Point)::void
  
  (map-x x::real y::real)::real
  (map-y x::real y::real)::real
  
  (unmap-x x::real y::real)::real
  (unmap-y x::real y::real)::real
  
  (map x::real y::real)::(Values real real)
  (unmap x::real y::real)::(Values real real)

  (translate! dx::real dy::real)::void
  (stretch! p0::Point q0::Point p1::Point q1::Point)::void
