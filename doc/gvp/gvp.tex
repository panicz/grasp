...
second prototype consisted of almost 3000 lines of Java code.
...
of GRASP. This reason alone was a sufficient to drop almost 10000
...
The decision to make GRASP available on PC wasn't dictated only by the
desire of making tests more efficient. Just like Android phone seems
to be a natural environment to develop apps that are meant to run on
Android phones and utilize multi-touch screens, developing on a PC
seems to be a good fit if we want to create applications that are
controlled by a keyboard and a mouse. 
...
The fourth prototype of GRASP consists of over 30000 lines of code, so
it is a failry large project. It is also the most feature-complete
version -- it supports most of the syntax of the Scheme programming
language, including of course lists and atoms, but also strings
and three types of comments (line comments, block comments and
expression comments). 
