...
not related to GVP. Finally, we present the design and implementation
of GRASP, our experimental GVP system, highlighting major design
decisions, lessons learned, and future directions.
\end{abstract}
...
Functional Programming. The systems ranged from research prototypes to
...
This is not to say that visual programming is inherently worse or less
capable than textual programming. But there is no doubt that textual
programming has an uncomparably more established tradition.
