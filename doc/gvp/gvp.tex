...
a \textit{system documentation} or a \textit{learning resource} for
programmers to figure the system out.


motivation, document representation, C4 browser, JS/WASM version,
