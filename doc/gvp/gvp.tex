...
preclude circular dependencies, the modules that make up a project
...
as well as the demo from Ivan Daniluk's 2019 GopherCon Europe talk
titled \textit{Rethinking Visual Programming}.}.
