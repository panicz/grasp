...
network\footnote{\url{https://eidolon-language.quora.com/Draggable-rectangle-challenge-part-I-the-introduction}}, which consisted of three tasks:
...
extensions were hardcoded in the editor, the extension mechanism was
already designed to be convenient to the users: it simply required to
...
The entire prototype consisted of less than 1000 lines of code, and it
...
\begin{figure}[h]
  ...
  \caption{A structural representation of a directed graph and its visualization}
...
of programming that would involve small multitouch-capable touch
screens.
