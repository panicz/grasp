...
smoothly zoom out to see entire documents at once. This perspective is
not particularly useful though -- those documents usually look like
vertical white stripes with some illegible dark spots on them.
...
actually be useful, and that such view could contain a class
diagram or function signatures, devoid of their actual implmentations.
...
representation usually represents a module as a generic icon with a
file name, residing in a directory tree. While this representation
gives some information, there is a lot of information that it misses.
In particular, the size of the icon could depend (logarithmically or
...
In particular, it would be worth to integrate the GRASP system with
web browsers and their JavaScript/WebAssembly runtime environments in
order to be able to have GRASP snippets (including extensions such as
its visual stepper) available on web pages.
